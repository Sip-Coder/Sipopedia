...
Prepared for: Jonathan Yu
Prepared: June 2, 2026
Las Vegas, NV | JonYu3@gmail.com | 617.637.0668 | SipStudies.com | Sipopedia.com

## Recommendation
Best application priority with remote work as a major condition: AI Deployment Engineer- Codex.
Second remote priority: AI Success Engineer - US Remote.
Strongest non-remote qualification match: Customer Education, Learning Experience & Curriculum Lead.

The application packets below preserve both paths: a remote-first route that protects Las Vegas stability, and a non-remote route only if the role economics and career upside justify San Francisco.

## Ranked Application Targets

### 1. AI Deployment Engineer- Codex
Team: Technical Success
Location: Remote - US
Compensation: $197K-$278K + equity
Posting: https://openai.com/careers/ai-deployment-engineer-codex-remote-us/

Best remote-first fit; strongest match for hands-on AI coding workflows, demos, technical workshops, and customer enablement.
...
### 2. AI Success Engineer - US Remote
Team: AI Success
Location: Remote - US
Compensation: $234K-$260K + equity
Posting: https://openai.com/careers/ai-success-engineer-us-remote-remote-us/

Strong remote option; good match for adoption, customer enablement, KPI framing, and technical-business translation, with enterprise technical depth as the main stretch.
...
### 3. Product Marketing Manager, Codex
Team: Marketing
Location: Remote - US with regular travel to San Francisco
Compensation: $227K-$315K + equity
Posting: https://openai.com/careers/product-marketing-manager-codex-remote-us/

Remote stretch option; credible on technical narratives and adoption content, but the 14+ years developer-marketing requirement is the main gap.
...
### 4. Customer Education, Learning Experience & Curriculum Lead
Team: GTM Readiness
Location: San Francisco
Compensation: $207K-$230K + equity
Posting: https://openai.com/careers/customer-education-learning-experience-and-curriculum-lead-san-francisco/

Strongest non-remote qualification match; excellent education, curriculum, assessment, and AI-learning systems fit if San Francisco becomes realistic.
...
### 5. AI Deployment Manager - Core Ecosystem, EDU
Team: Technical Success
Location: San Francisco and New York City
Compensation: $162K-$230K + equity
Posting: https://openai.com/careers/ai-deployment-manager-core-ecosystem-edu-san-francisco/

Excellent education and adoption match; location is hybrid SF/NYC rather than remote.
...
### 6. Deployed Product Manager, Codex
Team: Codex - Engineering
Location: San Francisco
Compensation: $250K-$330K + equity
Posting: https://openai.com/careers/deployed-product-manager-codex-san-francisco/

Strong founder/product stretch; best if positioning around technical founder execution, customer strategy, hands-on unblocking, and product judgment.
...
- The Customer Education and EDU Deployment Manager packets should emphasize curriculum, live teaching, assessment, credentialing, AI literacy, and adoption operations if location becomes workable.
- The AI Deployment Engineer, AI Success Engineer, and Deployed Product Manager packets should emphasize technical workflow mapping, AI-assisted building, product fluency, customer enablement, account analytics, and measurable adoption.
