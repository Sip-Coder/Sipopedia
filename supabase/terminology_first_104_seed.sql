-- First 104-term batch for Sip Studies terminology.
-- Composition:
-- - 52 letter terms: exactly 2 terms for each letter A-Z.
-- - 52 number-prefixed terms for the # bucket (00-25, two terms each).
--
-- All definitions below are original rewrites designed for Sip Studies.
...
select
  ...
  'Original Sip Studies editorial rewrite with topical references from official documentation and standards pages.',
  true
from seed_terms s
