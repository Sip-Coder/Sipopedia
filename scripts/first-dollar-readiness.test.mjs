...
import { buildMembershipSupportRoute } from "../src/lib/onboardingIntent.ts";
import { workspaceLabelForRoute } from "../src/lib/workspaceNavigation.ts";

const [adminSource, supportSource, checkoutFunctionSource, readinessDoc] = await Promise.all([
